  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="md:container mx-auto px-4 py-3 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 md:mb-12">
          ...
          <div className="space-y-4">
            ...
            <Splide
              options={{
                ...
                gap: "8px", // No gap between thumbnails
                ...
                breakpoints: {
                  768: {
                    perPage: 4, // On mobile, show only 1 image
                  },
                  1024: {
                    perPage: 5,
                  },
            ...
            >
              {images.map((image, index) => (
                <SplideSlide key={index}>
                  <div
                    className="w-16 h-16 bg-gray-200 rounded border-2 border-gray-300 hover:border-green-500 cursor-pointer"
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-4 pt-3">
              ...
              <button className="bg-green-700 text-white px-6 py-2 rounded hover:bg-green-900 flex-1 max-w-[250px]">
                Proceed to checkout
              </button>
            </div>

            {/* Guarantees */}
            <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-4 pt-4 border-t">
              <div className="flex items-center space-x-2">
                ...
                />
                <div>
                  <div className="text-green-800 font-bold">Free Delivery</div>
        ...
        {/* Customer Feedback */}
        <div className="md:mb-12 lg:w-[80%] 2xl:w-[70%]">
